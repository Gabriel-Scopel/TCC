...
with open(r'D:\Downloads\ProjTCCMurilo\dataset\BasesTratadas\enData.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
with open(r'D:\Downloads\ProjTCCMurilo\Ollama\deepseekEN.json', 'w', encoding='utf-8') as f:
    json.dump(resultado_alunos, f, ensure_ascii=False, indent=4)

print("Resultados salvos em 'DeepSeekEN.json'.")
