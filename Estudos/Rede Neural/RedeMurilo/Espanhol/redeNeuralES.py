...
with open('dadosES.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
with open('pesosES_MLP.json', 'w', encoding='utf-8') as f:
...
with open('pesosES_MLP.json', 'r', encoding='utf-8') as f:
    pesos = json.load(f)
...
with open('media_ES_MLP.json', 'w', encoding='utf-8') as f:
    json.dump(output_records, f, ensure_ascii=False, indent=4)

print("Arquivo gerado: media_ES_MLP.json")
print("Pesos salvos em: pesosES_MLP.json")
