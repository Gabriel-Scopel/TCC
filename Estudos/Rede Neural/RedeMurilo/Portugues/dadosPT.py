...
arquivos_elmo = [
    "D:\Downloads\ProjTCCMurilo\correcoes\correcao_elmo_PT.json",
]

arquivos_use = [
    "D:\Downloads\ProjTCCMurilo\correcoes\correcao_usePT.json",
]

arquivos_bert = [
    "D:\Downloads\ProjTCCMurilo\correcoes\correcao_bertPT.json",
]

arquivos_deepseek = [ 
    "D:\Downloads\ProjTCCMurilo\Ollama\deepseekPT.json",
]
        ...
        with open(arquivo, "r", encoding="utf-8") as f:
            ...
            for item in dados_json:
                ...
                if chave in dados_unificados:
                    ...
                    # Se existir a similaridade, adiciona também
...
def carregar_e_adicionar_bert(arquivos, chave_nota):
    ...
    for arquivo in arquivos:
        with open(arquivo, "r", encoding="utf-8") as f:
            dados_json = json.load(f)
            for item in dados_json:
                for resposta_aluno in item["responses_students"]:  # Acessa cada resposta dos alunos
...
output_path = "D:/Downloads/ProjTCCMurilo/dadosPT.json"
