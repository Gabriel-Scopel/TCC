...
with open("enData.json", "r", encoding="utf-8") as file:
    data = json.load(file)
...
with open("bert_graded_responses.json", "w", encoding="utf-8") as output_file:
    json.dump(data, output_file, indent=4, ensure_ascii=False)

print("Correção concluída! As respostas foram salvas em 'graded_responses.json'")
